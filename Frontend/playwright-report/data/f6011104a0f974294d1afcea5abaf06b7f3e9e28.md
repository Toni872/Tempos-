...
- Name: gps-fichaje.spec.js >> GPS Fichaje E2E Tests >> Almacenamiento de coordenadas y timestamps
- Location: tests\e2e\gps-fichaje.spec.js:124:3
...
- generic [ref=e2]:
  - generic [ref=e4]:
    - generic [ref=e5]:
      ...
      - generic [ref=e9]:
        ...
        - generic [ref=e25]:
          ...
          - alert [ref=e30]: "Firebase: Error (auth/too-many-requests)."
          - generic [ref=e31]:
    ...
    - generic [ref=e53]:
      - img "Visual login admin" [ref=e54]
      - generic:
        - generic: El control vuelve a ti.
        - generic: Accede a tus datos en tiempo real.
  - button "Acceso Móvil Descargar APP" [ref=e55] [cursor=pointer]:
    - img [ref=e57]
    - generic [ref=e61]:
      - generic [ref=e62]: Acceso Móvil
      - generic [ref=e63]: Descargar APP
    - img [ref=e65]
```
