...
- Name: gps-fichaje.spec.js >> GPS Fichaje E2E Tests >> Rechazo por precisión GPS insuficiente
- Location: tests\e2e\gps-fichaje.spec.js:51:3
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e9]:
        ...
        - generic [ref=e25]:
          ...
          - alert [ref=e30]: "Firebase: Error (auth/invalid-credential)."
          - generic [ref=e31]:
