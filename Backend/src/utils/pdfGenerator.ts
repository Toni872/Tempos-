...
function drawTemposLogo(
  ...
  doc
    ...
    .font("Helvetica-Bold")
    .fontSize(size * 0.8)
    .text("Tem", x + size + 8, y + size / 4, { continued: true });
...
export async function generateInspectionPDF(
  ...
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .fontSize(8)
      .text(
        "CONFORME AL ARTÍCULO 34.9 DEL ESTATUTO DE LOS TRABAJADORES (RDL 8/2019)",
        { align: "right" },
      );
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fontSize(8)
      .text("DATOS DE LA EMPRESA", 50, gridY);
    ...
    fichas.forEach((f, i) => {
      ...
      doc
        .font("Helvetica-Bold")
        .text(`${f.hoursWorked || 0}h`, 285, rowY)
        .font("Helvetica");
    ...
    doc
      .font("Helvetica-Bold")
      .text(
        "Software Certificado por Script-9 (www.script-9.com)",
        50,
        footerY + 22,
        { align: "center", width: 495 },
      );
...
export async function generateAuditPDF(
  ...
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fontSize(18)
      .text("AUDITORÍA TÉCNICA DE GEOLOCALIZACIÓN", { align: "right" });
    doc
      .fillColor(BRAND_BLUE)
      .font("Helvetica-Bold")
      .fontSize(9)
      .text("CERTIFICADO DE PRESENCIA DIGITAL", { align: "right" });
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fontSize(8)
      .text("INFORME DE CUMPLIMIENTO", 65, infoY + 12);

    doc.fillColor(BRAND_DARK).font("Helvetica").fontSize(9);
    doc
      .text(`Empresa:`, 65, infoY + 28, { continued: true })
      .font("Helvetica-Bold")
      .text(` ${employerName}`);
    doc
      .font("Helvetica")
      .text(`Empleado:`, 65, infoY + 42, { continued: true })
      .font("Helvetica-Bold")
      .text(` ${targetUser?.displayName || "Reporte General"}`);

    doc
      .font("Helvetica")
      .text(`Fecha Emisión:`, 300, infoY + 28, { continued: true })
      .font("Helvetica-Bold")
      .text(` ${new Date().toLocaleString("es-ES")}`);
    doc
      .font("Helvetica")
      .text(`Estado Auditoría:`, 300, infoY + 42, { continued: true })
      .fillColor("#059669")
      .font("Helvetica-Bold")
      .text(` VERIFICADA ✅`);
    ...
    doc
      .font("Helvetica-Bold")
      .text(
        "Verificación Tecnológica por Script-9 (www.script-9.com)",
        50,
        footerY + 28,
        { align: "center", width: 495 },
      );
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fontSize(7)
      .text("SCRIPT-9 SECURITY SEAL", 385, sigY + 10, {
        align: "center",
        width: 130,
      });
    doc
      .fontSize(6)
      .text("AUTHENTICATED DATA", 385, sigY + 25, {
        align: "center",
        width: 130,
      });
    doc
      .fontSize(5)
      .text(
        `ID: S9-${Math.random().toString(36).substring(7).toUpperCase()}`,
        385,
        sigY + 40,
