  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!hasAbsences) {
      ...
      await queryRunner.createIndex(
        "absences",
        new TableIndex({
          name: "IDX_absences_userId_startDate",
    ...
    if (!hasDocuments) {
      ...
      await queryRunner.createIndex(
        "documents",
        new TableIndex({
          name: "IDX_documents_userId_createdAt",
    ...
    if (!hasAuditLogs) {
      ...
      await queryRunner.createIndex(
        "audit_logs",
        new TableIndex({
          name: "IDX_audit_logs_companyId_createdAt",
